...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  SITUS TERGACOR ${YELLOW}(${NC}${green} KUNTUL ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e " PENCIPTA ${green} SAHA ${NC}${YELLOW}(${NC} ${green} Yass vpn Tunneling ${NC}${YELLOW})${NC}"
echo -e " XNXX.COM${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/Rehanzcraker/HanzProjec/main/izinv2 | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/Rehanzcraker/HanzProjec/main/izinv2 | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/Rehanzcraker/HanzProjec/main/izinv2 | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/nixy-pro/vpn/main/"
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/Rehanzcraker/HanzProjec/main/izinv2 | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/Rehanzcraker/HanzProjec/main/izinv2 | grep $ipsaya | awk '{print $3}')
